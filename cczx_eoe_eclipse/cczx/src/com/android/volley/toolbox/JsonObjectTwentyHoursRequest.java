 ...
 */
public class JsonObjectTwentyHoursRequest extends JsonRequest<JSONObject> {
     ...
     */
    public JsonObjectTwentyHoursRequest(int method, String url, JSONObject jsonRequest,
     ...
     */
    public JsonObjectTwentyHoursRequest(String url, JSONObject jsonRequest, Listener<JSONObject> listener,
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            return Response.success(new JSONObject(jsonString),
                    HttpHeaderParser.parseIgnoreCacheHeaders(response, 12 * 60 * 60 * 1000, 12 * 60 * 60 * 1000));
