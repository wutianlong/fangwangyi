 ...
 */
public class JsonObjectLongRequest extends JsonRequest<JSONObject> {
     ...
     */
    public JsonObjectLongRequest(String url, JSONObject jsonRequest, Listener<JSONObject> listener,
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            return Response.success(new JSONObject(jsonString),
                    HttpHeaderParser.parseIgnoreCacheHeaders(response, 365 * 24 * 60 * 60 * 1000, 365 * 24 * 60 * 60 * 1000));
